using ProjectVegans.Controller;
...
namespace ProjectVegans
{
    public partial class Form1 : Form
    {
        ...
        TypeLogic veganTypeController = new TypeLogic();
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void btn_SelectAll_Click(object sender, EventArgs e)
        {
            ...
            foreach (var Items in allVegans)
            {
                listBox1.Items.Add($"{Items.Id}.Name - {Items.Name} - Price: {Items.Price}, Description - {Items.Description}, Type - {Items.Types.Name}");
            }
        }
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                updatedVegan.VeganTypeId = (int)cmb_Type.SelectedValue;
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            newVegans.VeganTypeId = (int)cmb_Type.SelectedValue;
